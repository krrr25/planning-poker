...
Internal sprint estimation tool. Facilitators (BA / PO / SM) create a room; the team joins with a link and votes.
...
1. Copy env and set your Atlas URI plus the first admin:
